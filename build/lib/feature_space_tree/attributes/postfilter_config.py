...
class FactorySimpleDecoratorByTokenNormalizer(object):
    ...
    def create(option, kwargs, by_token_normalizer):
        # DEBUG: 
        print "Fac#######", str(option), " DICT: ", kwargs 
        option = eval(option)
        ...
        if option == EnumDecoratorByTokenNormalizer.GAP_BIGRAMS:
            print "ESTOY EN GAP"
            return GapBigramsFilterDecoratorByTokenNormalizer(by_token_normalizer, kwargs['gap_size'])
