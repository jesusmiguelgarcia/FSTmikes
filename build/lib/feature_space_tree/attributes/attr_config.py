...
class FactoryTermLex(FactoryTerm):
    ...
    def create(self, option, kwargs):
        ...
        elif option == EnumTermLex.POS_FREELING:
            return TermPOS_FREELING(kwargs)
        ...
        elif option == EnumTermLex.WORD_PAIR_OPCION:
            return TermWord_Pair_Opcion(kwargs)
