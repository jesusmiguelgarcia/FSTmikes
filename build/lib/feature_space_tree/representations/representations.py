...
# revisar para agregar como premiar a los atributos que me interesan
# BOWMatrixHolder
# linea 6600
# ==============================================================================
#BOWMatrixHolder
...
class FactoryBOWARGRepresentation(AbstractFactoryRepresentation):
    ...
    def create_matrix_train_holder(self, space):        
        self.__bow_train_matrix_holder = BOWARGTrainMatrixHolder(space) 
    ...
    def create_matrix_test_holder(self,space):
        self.__bow_test_matrix_holder = BOWARGTestMatrixHolder(space) 
...
#se puede agregar aqui information gain
...
class BOWARGMatrixHolder(MatrixHolder):
    ...
    def __init__(self, space):
        super(BOWARGMatrixHolder, self).__init__()
        self.space = space
        #self.build_matrix()
    ...
    def build_matrix_doc_terminos(self,
        ...
        print "VAL_ARGUMENT_X:", space.kwargs_space["argument_x"]
        #tomar valores de la lista
        factor=space.kwargs_space["factor"]
        json_data=""
        cadena= space.kwargs_space["argument_x"]
...
class BOWARGTrainMatrixHolder(BOWARGMatrixHolder):
    ...
    def __init__(self, space):
        super(BOWARGTrainMatrixHolder, self).__init__(space)
    ...
    def load_train_data(self, space):
        ...
        bow_train_matrix_holder = BOWARGTrainMatrixHolder(space)        
        bow_train_matrix_holder.set_matrix(numpy.load(cache_file + "_mat_docs_terms.npy"))
        bow_train_matrix_holder.set_instance_namefiles(numpy.load(cache_file + "_instance_namefiles.npy"))
        bow_train_matrix_holder.set_instance_categories(numpy.load(cache_file + "_instance_categories.npy"))      
...
class BOWARGTestMatrixHolder(BOWARGMatrixHolder):

    def __init__(self, space):
        super(BOWARGTestMatrixHolder, self).__init__(space)
...
#            type_corpus = match.group(1)
            ...
            print term_corpus_file
            shelf = shelve.open(term_corpus_file, protocol=1)
...
class SpaceComposite(SpaceComponent):
    ...
    def get_attributes(self):
        ...
        for space_component in self.space_components:
            print space_component.get_attributes()
